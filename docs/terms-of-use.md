...
(2)	Developer Studio Connection Plan means a purchase plan, paid on a monthly basis, which includes, among other things, access to the Fiserv APIs, the Developer Build Space, developer support, transaction volume limits, and related options.
...
(1)	You agree to pay us (A) fees for the Developer Studio Connection Plan you purchase, as well as for any add-on, additional, or optional services you purchase, and (B) Taxes as defined below. Our fees, rates and charges may be increased annually effective each January 1.
