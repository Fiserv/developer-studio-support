...
(2)  You are responsible to pay all sales, use, excise, value added, withholdings and other taxes and duties however designated that are levied by any taxing authority relating to your Developer Studio Connection Plan (Taxes). All fees and other charges related to your Developer Studio Connection Plan are exclusive of Taxes. You shall reimburse us for those Taxes that we are required to remit on your behalf. In no event shall Taxes include taxes based on our income.
